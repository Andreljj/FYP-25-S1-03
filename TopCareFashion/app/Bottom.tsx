...
import { mockBottoms } from './data/mockData';
...
export default function BottomsScreen() {
  ...
  const [products, setProducts] = useState(mockBottoms);
  ...
  useEffect(() => {
    ...
    const sortedProducts = [...mockBottoms];
  ...
  return (
    <SafeAreaView style={styles.container}>
      <NavigationBar showBackButton={true} activeTab="BOTTOM" />
