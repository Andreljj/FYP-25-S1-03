...
const SellerPage = () => {
  ...
  const [profileImage, setProfileImage] = useState('https://images.unsplash.com/photo-1633332755192-727a05c4013d?q=80&w=1000&h=1000');

  const [profileData, setProfileData] = useState({
    username: 'eco_closet',
    email: '',
    bio: 'Ready-to-wear collections fuelled by a passion for innovative design',
    profileImage: 'https://images.unsplash.com/photo-1633332755192-727a05c4013d?q=80&w=1000&h=1000',
    followers: 2263,
    following: 334,
    listings: 45,
    phone: '',
  ...
  const handleReport = () => {
    Alert.alert(
      ...
      [
        ...
        {
          text: "Report",
          onPress: () => Alert.alert("Report Submitted", "Thank you for your report. We will review it shortly."),
          style: "destructive"
        }
      ]
    );
                ...
                <View style={styles.profileNameRow}>
                  ...
                  >
                    <View style={styles.reportContent}>
                      <Ionicons name="alert-circle" size={19} color="white" />
