...
// app/footwear.tsx
import { mockFootwear } from './data/mockData';

// Use mockFootwear instead of locally defined data
...
export default function FootwearScreen() {
  ...
  const [products, setProducts] = useState(mockFootwear);
  ...
  useEffect(() => {
    ...
    const sortedProducts = [...mockFootwear];
  ...
  return (
    <SafeAreaView style={styles.container}>
      <NavigationBar showBackButton={true} activeTab="FOOTWEAR" />
